To download a zipped version of the extracted glucose files and metadata harmonized by the Glucose-ML standard, please download the CGMacros_Libre-from-Glucose-ML.zip file.
